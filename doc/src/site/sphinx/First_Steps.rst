...
**Note:** '_id' field is autogenerated in MongoDB, so by default, you can filter it as String. If you want to write '_id', you have to set 'objectid' property to "false" like in the above table.
